...
var _user$project$Shared$playerXPos = 50;
var _user$project$Shared$maxPower = 100;
var _user$project$Shared$playerHeight = 64;
var _user$project$Shared$playerWidth = 64;
var _user$project$Shared$holeSize = 200;
var _user$project$Shared$treeWidth = 80;
var _user$project$Shared$groundHeight = 80;
var _user$project$Shared$gameHeight = 640;
var _user$project$Shared$gameWidth = 480;
var _user$project$Shared$gameSpeed = 375;

var _user$project$Model$Tree = F2(
	function (a, b) {
		return {holeHeight: a, xPos: b};
	});
var _user$project$Model$addTree = F2(
	function (holeHeight, model) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				trees: {
					ctor: '::',
					_0: A2(_user$project$Model$Tree, holeHeight, _user$project$Shared$gameWidth),
					_1: model.trees
				}
			});
	});
							...
							return function (h) {
								return function (i) {
									return function (j) {
										return function (k) {
											return function (l) {
												return {gameState: a, highscore: b, score: c, space: d, power: e, height: f, xPos: g, velocity: h, rotation: i, trees: j, secondsSinceSpawn: k, groundPosition: l};
											};
										};
									};
								};
...
var _user$project$Model$Waiting = {ctor: 'Waiting'};
var _user$project$Model$init = function (highscore) {
	return {
		gameState: _user$project$Model$Waiting,
		highscore: highscore,
		score: 0,
		space: false,
		power: 0,
		height: _user$project$Shared$groundHeight,
		xPos: -100,
		velocity: 0,
		rotation: 0,
		trees: {ctor: '[]'},
...
var _user$project$Update$collisionDetection = function (model) {
	var collision = F2(
		function (player, tree) {
			return (_elm_lang$core$Native_Utils.cmp(player.left, tree.right) < 0) && ((_elm_lang$core$Native_Utils.cmp(player.right, tree.left) > 0) && ((_elm_lang$core$Native_Utils.cmp(player.top, tree.bottom) > 0) && (_elm_lang$core$Native_Utils.cmp(player.bottom, tree.top) < 0)));
		});
	var playerBox = {top: model.height + _user$project$Shared$playerHeight, bottom: model.height, left: _user$project$Shared$playerXPos, right: _user$project$Shared$playerXPos + _user$project$Shared$playerWidth};
	var treeTrunkBoxes = function (_p0) {
		var _p1 = _p0;
		var _p3 = _p1.xPos;
		var _p2 = _p1.holeHeight;
		var box = F2(
			function (top, bottom) {
				return {top: top, bottom: bottom, left: _p3, right: _p3 + _user$project$Shared$treeWidth};
			});
		var topTrunk = A2(
			box,
			_user$project$Shared$gameHeight,
			_elm_lang$core$Basics$toFloat(_p2));
		var bottomTrunk = A2(
			box,
			_elm_lang$core$Basics$toFloat(_p2) - _user$project$Shared$holeSize,
			_user$project$Shared$groundHeight);
		return {
			ctor: '::',
			_0: topTrunk,
			_1: {
	...
	var allTrunkBoxes = A2(_elm_lang$core$List$concatMap, treeTrunkBoxes, model.trees);
	var collided = A2(
		_elm_lang$core$List$any,
		collision(playerBox),
		allTrunkBoxes);
	return collided ? _elm_lang$core$Native_Utils.update(
		model,
		{
			gameState: _user$project$Model$Waiting,
...
var _user$project$Update$moveGround = F2(
	function (delta, model) {
		var groundPieceWidth = 24;
		var newPos = model.groundPosition - (delta * _user$project$Shared$gameSpeed);
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				groundPosition: (_elm_lang$core$Native_Utils.cmp(newPos, 0 - groundPieceWidth) < 0) ? (newPos + groundPieceWidth) : newPos
			});
	});
var _user$project$Update$moveTrees = F2(
	function (delta, _p4) {
		var _p5 = _p4;
		var _p7 = _p5.trees;
		var _p6 = _p5.score;
		var diff = _elm_lang$core$List$map(
			function (tree) {
				return _elm_lang$core$Native_Utils.cmp(_user$project$Shared$playerXPos, tree.xPos + _user$project$Shared$treeWidth) > 0;
			});
		var moveTree = function (tree) {
			return _elm_lang$core$Native_Utils.update(
				tree,
				{xPos: tree.xPos - (delta * _user$project$Shared$gameSpeed)});
		};
		var movedTrees = A2(_elm_lang$core$List$map, moveTree, _p7);
		return _elm_lang$core$Native_Utils.update(
			_p5,
			{
				trees: movedTrees,
				score: _elm_lang$core$Native_Utils.eq(
					diff(_p7),
					diff(movedTrees)) ? _p6 : (_p6 + 1)
			});
	});
var _user$project$Update$stepPlayer = F2(
	function (delta, _p8) {
		var _p9 = _p8;
		var _p10 = _p9.velocity;
		var nextRotation = _p9.rotation - (430 * delta);
		return _elm_lang$core$Native_Utils.update(
			_p9,
			{
				height: A2(_elm_lang$core$Basics$max, _user$project$Shared$groundHeight, _p9.height + (_p10 * delta)),
				xPos: A2(_elm_lang$core$Basics$min, _p9.xPos + (delta * 60), _user$project$Shared$playerXPos),
				velocity: _p10 - (delta * 2750),
				rotation: (_elm_lang$core$Native_Utils.cmp(nextRotation, -360) < 0) ? (nextRotation + 360) : nextRotation
			});
	});
var _user$project$Update$fillPower = F2(
	function (delta, _p11) {
		var _p12 = _p11;
		var newPower = (_p12.space && _elm_lang$core$Native_Utils.eq(_p12.height, _user$project$Shared$groundHeight)) ? (_p12.power + (delta * 300)) : 0;
		return _elm_lang$core$Native_Utils.update(
			_p12,
			{
				power: A3(_elm_lang$core$Basics$clamp, 0, _user$project$Shared$maxPower, newPower)
			});
	});
var _user$project$Update$step = F2(
	function (delta, model) {
		return _user$project$Update$collisionDetection(
			A2(
				_user$project$Update$moveGround,
				delta,
				A2(
					_user$project$Update$moveTrees,
					delta,
					A2(
						_user$project$Update$stepPlayer,
						delta,
						A2(_user$project$Update$fillPower, delta, model)))));
	});
var _user$project$Update$saveHighscore = _elm_lang$core$Native_Platform.outgoingPort(
	'saveHighscore',
	function (v) {
		return v;
	});
var _user$project$Update$Noop = {ctor: 'Noop'};
var _user$project$Update$SetSpace = function (a) {
	return {ctor: 'SetSpace', _0: a};
};
var _user$project$Update$SpawnTree = function (a) {
	return {ctor: 'SpawnTree', _0: a};
};
var _user$project$Update$spawnTree = F2(
	function (delta, model) {
		var treeOffset = 15;
		var newModel = _elm_lang$core$Native_Utils.update(
			model,
			{
				trees: A2(
					...
					function (tree) {
						return _elm_lang$core$Native_Utils.cmp(tree.xPos, 0 - _user$project$Shared$treeWidth) > 0;
					},
					model.trees)
			});
		var sinceSpawn = model.secondsSinceSpawn + delta;
		var spawnTime = 2.6;
		return (_elm_lang$core$Native_Utils.cmp(sinceSpawn, spawnTime) > -1) ? {
			ctor: '_Tuple2',
			...
			_1: A2(
				_elm_lang$core$Random$generate,
				_user$project$Update$SpawnTree,
				A2(_elm_lang$core$Random$int, (_user$project$Shared$holeSize + _user$project$Shared$groundHeight) + treeOffset, _user$project$Shared$gameHeight - treeOffset))
		} : {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Native_Utils.update(
				newModel,
				{secondsSinceSpawn: sinceSpawn}),
...
var _user$project$Update$update = F2(
	function (msg, _p13) {
		var _p14 = _p13;
		var _p21 = _p14;
		var _p20 = _p14.highscore;
		var _p19 = _p14.gameState;
		var _p15 = msg;
		switch (_p15.ctor) {
			case 'Tick':
				var delta = _elm_lang$core$Time$inSeconds(
					A2(_elm_lang$core$Basics$min, _p15._0, 25));
				var _p16 = _p19;
				if (_p16.ctor === 'Playing') {
					return A2(
						_user$project$Update$spawnTree,
						delta,
						A2(_user$project$Update$step, delta, _p21));
				} else {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							_p21,
							{height: _p21.height - (delta * 750), xPos: _p21.xPos + (delta * 250)}),
						_1: _user$project$Update$saveHighscore(_p20)
					};
				}
			case 'SpawnTree':
				return {
					ctor: '_Tuple2',
					_0: A2(_user$project$Model$addTree, _p15._0, _p21),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'SetSpace':
				var _p18 = _p15._0;
				return {
					...
					_0: function () {
						var _p17 = _p19;
						if (_p17.ctor === 'Waiting') {
							if (_elm_lang$core$Native_Utils.eq(_p18, false)) {
								var nextModel = _user$project$Model$init(_p20);
								return _elm_lang$core$Native_Utils.update(
									nextModel,
									{gameState: _user$project$Model$Playing});
							} else {
								return _p21;
							}
						} else {
							return _elm_lang$core$Native_Utils.update(
								...
								{
									space: _p18,
									velocity: (_elm_lang$core$Native_Utils.eq(_p14.height, _user$project$Shared$groundHeight) && _elm_lang$core$Native_Utils.eq(_p18, false)) ? ((_p14.power * 12.2) + 380) : _p14.velocity,
									gameState: _user$project$Model$Playing
								});
						}
					}(),
...
var _user$project$View$movingGround = function (groundPosition) {
	return A2(
		_evancz$elm_graphics$Collage$move,
		{ctor: '_Tuple2', _0: groundPosition, _1: -254},
		_evancz$elm_graphics$Collage$toForm(
			A3(_evancz$elm_graphics$Element$tiledImage, _user$project$Shared$gameWidth + 50, 12, 'images/moving_ground.png')));
};
var _user$project$View$text = function (_p0) {
	var _p1 = _p0;
	var _p3 = _p1.score;
	var txt = F5(
		function (size, x, y, string, color) {
			return A2(
				_evancz$elm_graphics$Collage$move,
	...
	var text = F3(
		function (size, height, string) {
			return _evancz$elm_graphics$Collage$group(
				{
					ctor: '::',
					_0: A5(txt, size, 0, height, string, _elm_lang$core$Color$black),
					_1: {
						ctor: '::',
						_0: A5(txt, size, -3, height + 3, string, _elm_lang$core$Color$white),
						_1: {ctor: '[]'}
					}
				});
		});
	...
	if (_p2.ctor === 'Playing') {
		return A3(
			text,
			50,
			_user$project$Shared$gameHeight / 4,
			_elm_lang$core$Basics$toString(_p3));
	} else {
		return _evancz$elm_graphics$Collage$group(
			{
				ctor: '::',
				_0: A3(text, 25, (_user$project$Shared$gameHeight / 3) + 20, 'score'),
				_1: {
					ctor: '::',
					_0: A3(
						text,
						25,
						(_user$project$Shared$gameHeight / 3) - 20,
						_elm_lang$core$Basics$toString(_p3)),
					_1: {
						ctor: '::',
						_0: A3(text, 25, (_user$project$Shared$gameHeight / 3) - 80, 'best'),
						_1: {
							ctor: '::',
							_0: A3(
								text,
								25,
								(_user$project$Shared$gameHeight / 3) - 120,
								_elm_lang$core$Basics$toString(_p1.highscore)),
							_1: {
								ctor: '::',
								_0: A3(text, 25, (_user$project$Shared$gameHeight / 3) - 250, 'Press space'),
								_1: {ctor: '[]'}
							}
						}
					}
...
var _user$project$View$position = F2(
	function (_p4, element) {
		var _p5 = _p4;
		return A2(
			_evancz$elm_graphics$Collage$move,
			{ctor: '_Tuple2', _0: _p5._0, _1: _p5._1},
			_evancz$elm_graphics$Collage$toForm(
				A4(_evancz$elm_graphics$Element$container, _user$project$Shared$gameWidth, _user$project$Shared$gameHeight, _evancz$elm_graphics$Element$bottomLeft, element)));
	});
var _user$project$View$player = function (_p6) {
	var _p7 = _p6;
	var img = function () {
		var _p8 = _p7.gameState;
		if (_p8.ctor === 'Playing') {
			return 'frog1';
		} else {
			return 'frog2';
	...
	return A2(
		_user$project$View$position,
		{ctor: '_Tuple2', _0: _p7.xPos, _1: _p7.height},
		A3(
			_evancz$elm_graphics$Collage$collage,
			_user$project$Shared$playerWidth,
			_user$project$Shared$playerHeight,
			_elm_lang$core$List$singleton(
				A2(
					_evancz$elm_graphics$Collage$rotate,
					_elm_lang$core$Basics$degrees(_p7.rotation),
					_evancz$elm_graphics$Collage$toForm(
						A3(
							_evancz$elm_graphics$Element$image,
							_user$project$Shared$playerWidth,
							...
							A2(
								_elm_lang$core$Basics_ops['++'],
								'images/',
								A2(_elm_lang$core$Basics_ops['++'], img, '.png'))))))));
};
var _user$project$View$power = function (power) {
	var powerScale = (_user$project$Shared$gameWidth - 32) / _user$project$Shared$maxPower;
	var powerWidth = power * powerScale;
	return A2(
		_user$project$View$position,
		{ctor: '_Tuple2', _0: 16, _1: 16},
		A3(
			_evancz$elm_graphics$Element$tiledImage,
			_elm_lang$core$Basics$floor(powerWidth),
			20,
			'images/power.png'));
};
var _user$project$View$trees = _elm_lang$core$List$map(
	function (_p9) {
		var _p10 = _p9;
		var topTreeHeight = _user$project$Shared$gameHeight - _p10.holeHeight;
		var bottomTreeHeight = ((_user$project$Shared$gameHeight - topTreeHeight) - _user$project$Shared$holeSize) - _user$project$Shared$groundHeight;
		var treeEndHeight = 8;
		var treeEndPart = A2(_evancz$elm_graphics$Element$image, _user$project$Shared$treeWidth, 4);
		var treeEndElement = F2(
			function (dir, height) {
				return A2(
					_evancz$elm_graphics$Element$flow,
					dir,
					{
						ctor: '::',
						_0: A3(_evancz$elm_graphics$Element$tiledImage, _user$project$Shared$treeWidth, height, 'images/tree_trunk.png'),
						_1: {
							ctor: '::',
							_0: treeEndPart('images/tree_end1.png'),
							_1: {
								ctor: '::',
								_0: treeEndPart('images/tree_end2.png'),
								_1: {ctor: '[]'}
							}
						}
					});
			});
		var topTree = A2(treeEndElement, _evancz$elm_graphics$Element$down, topTreeHeight - treeEndHeight);
		var bottomTree = A2(treeEndElement, _evancz$elm_graphics$Element$up, bottomTreeHeight - treeEndHeight);
		return A2(
			_user$project$View$position,
			{ctor: '_Tuple2', _0: _p10.xPos, _1: _user$project$Shared$groundHeight},
			A2(
				_evancz$elm_graphics$Element$flow,
				_evancz$elm_graphics$Element$down,
				{
					...
					_1: {
						ctor: '::',
						_0: A2(_evancz$elm_graphics$Element$spacer, _user$project$Shared$treeWidth, _user$project$Shared$holeSize),
						_1: {
							ctor: '::',
							_0: bottomTree,
							_1: {ctor: '[]'}
	...
	return A2(
		...
		},
		{
			...
			_0: _evancz$elm_graphics$Element$toHtml(
				A3(
					_evancz$elm_graphics$Collage$collage,
					_user$project$Shared$gameWidth,
					_user$project$Shared$gameHeight,
					A2(
						_elm_lang$core$Basics_ops['++'],
						{
							...
							_0: _evancz$elm_graphics$Collage$toForm(
								A3(_evancz$elm_graphics$Element$image, _user$project$Shared$gameWidth, _user$project$Shared$gameHeight, 'images/bg.png')),
							_1: {
								ctor: '::',
								_0: _user$project$View$movingGround(model.groundPosition),
								_1: {
									ctor: '::',
									_0: _user$project$View$power(model.power),
									_1: {ctor: '[]'}
								}
							}
						},
						A2(
							_elm_lang$core$Basics_ops['++'],
							_user$project$View$trees(model.trees),
							{
								ctor: '::',
								_0: _user$project$View$text(model),
								_1: {
									ctor: '::',
									_0: _user$project$View$player(model),
									_1: {ctor: '[]'}
								}
							})))),
			_1: {ctor: '[]'}
...
var _user$project$View$xOffset = _user$project$Shared$gameWidth / 2;
var _user$project$View$yOffset = _user$project$Shared$gameHeight / 2;

var _user$project$Main$subscriptions = function (model) {
	var toSpaceMsg = F2(
		function (isDown, keyCode) {
			return _elm_lang$core$Native_Utils.eq(keyCode, 32) ? _user$project$Update$SetSpace(isDown) : _user$project$Update$Noop;
		});
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _elm_lang$animation_frame$AnimationFrame$diffs(_user$project$Update$Tick),
			_1: {
				ctor: '::',
...
var _user$project$Main$main = _elm_lang$html$Html$programWithFlags(
	{
		init: function (highscore) {
			return {
				ctor: '_Tuple2',
				_0: _user$project$Model$init(highscore),
				_1: _elm_lang$core$Platform_Cmd$none
			};
		},
